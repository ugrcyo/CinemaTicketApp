...
namespace CinemaApp
{
    public partial class FrmSln5 : Form
    {
        public FrmSln5()
        {
            InitializeComponent();
        ...
        private void FrmSln5_Load_1(object sender, EventArgs e)
        {
            ...
            checkBox41.BackColor = Color.Green;
            checkBox42.BackColor = Color.Green;
            checkBox43.BackColor = Color.Green;
            checkBox44.BackColor = Color.Green;
            checkBox45.BackColor = Color.Green;
            checkBox46.BackColor = Color.Green;
            checkBox47.BackColor = Color.Green;
            checkBox48.BackColor = Color.Green;
            checkBox49.BackColor = Color.Green;
